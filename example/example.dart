...
void main() async {
  ...
  final file = await "https://images.unsplash.com/photo-1668882488934-544f9363c780?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxMHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60".head();
  print(file);
}
